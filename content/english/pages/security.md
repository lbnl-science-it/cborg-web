...
4. **[Handling PII and sensitive data with LLMs](/security_pii)** &mdash; how to use privacy filter models and NLP-based sanitization libraries to redact personally identifiable information (names, addresses, emails, etc.) before sending data to any LLM, including placeholder mapping for re-identification workflows.
...
> **Tip:** If your workflow involves user data such as names, email addresses, or other personal information, read the PII page before building any LLM-based pipeline.
